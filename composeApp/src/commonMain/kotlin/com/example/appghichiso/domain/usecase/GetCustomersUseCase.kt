...
class GetCustomersUseCase(private val customerRepository: CustomerRepository) {
    suspend operator fun invoke(roadCode: String, year: Int, month: Int, page: Int = 0): Result<List<Customer>> =
        customerRepository.getCustomers(roadCode, year, month, page)
}
